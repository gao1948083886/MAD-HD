...
class AOAIUtil:
    ...
    def __init__(
            self,
            config_setting: str = "gpt-35-turbo",
        ...
        self.client = openai.OpenAI(
            api_key= "EMPTY",  # This is the default and can be omitted
            base_url= f"http://202.207.12.183:{config[config_setting]['port']}/v1",
        )
        self.model = config[config_setting]['DEFAULT_ENGINE'] + '-183-' + config[config_setting]['port'][-1]
